...
effects are `perform`ed. Exceptions are caught, while effects are handled. Effect handlers allow smooth implementation of different things, like dependency injection,
